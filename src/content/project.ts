...
export const showcase = {
  ...
  hint: 'Move your cursor across the image to see the transition.',
  points: [
...
export const connected = {
  ...
  aerial: '/media/location/tower-aerial.jpg',
  aerialAlt: 'Aerial view of the Yamuna Sky City tower rising from coastal greenery, with National Highway 66 and a river bridge to the right and the Arabian Sea beach in the foreground',
  viewBox: { w: 1000, h: 563 },
  centre: { x: 533, y: 252 },
  rings: [148, 188, 228],
  lineEnd: 150,
  nodes: [
    { label: 'Beach', minutes: 2, x: 379, y: 106 },
    { label: 'National Highway 66', minutes: 2, x: 776, y: 108 },
    { label: 'Railway Station', minutes: 8, x: 310, y: 250 },
    { label: 'Ryan International School', minutes: 4, x: 834, y: 245 },
    { label: 'AJ Hospital', minutes: 7, x: 358, y: 405 },
    { label: 'City Centre', minutes: 15, x: 555, y: 452 },
    { label: 'Mangalore International Airport', minutes: 20, x: 755, y: 428 },
  ],
  highlights: [
